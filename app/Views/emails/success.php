    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card border-top-green shadow-lg text-center mx-550 px-5 py-2 gap-4">
          ...
          <h1 class="bg-medium-green text-white shadow rounded fw-bold px-3 py-2 fs-2">Seu email foi enviado com sucesso!</h1>

          <div class="text-bluish-green fw-bold">
            <?php echo date("Y") ?> -
            <?php 
            // Acessa as variáveis passadas pela controller
