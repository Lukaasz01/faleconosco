...
if (! function_exists('_get_uri')) {
     ...
     */
    function _get_uri($relativePath = '', $config = null): URI
    {
        ...
        if ($appConfig->forceGlobalSecureRequests && $uri->getScheme() === 'http') {
            $uri->setScheme('https');
        }
...
if (! function_exists('site_url')) {
     ...
     */
    function site_url($relativePath = '', $scheme = null, $config = null): string
    {
...
if (! function_exists('base_url')) {
     ...
     * @param string|null  $scheme       URI scheme. E.g., http, ftp
     */
    function base_url($relativePath = '', $scheme = null): string
    {
        /** @var App $config */
        $config = clone config('App');

        // Remove index page for base_url
        $config->indexPage = '';
...
if (! function_exists('current_url')) {
     ...
     */
    function current_url(bool $returnObject = false, $request = null)
    {
...
if (! function_exists('previous_url')) {
    ...
    function previous_url(bool $returnObject = false)
    {
        ...
        $referer = $session->get('_ci_previous_url') ?? Services::request()->getServer('HTTP_REFERER');
...
if (! function_exists('index_page')) {
     ...
     */
    function index_page($altConfig = null): string
    {
        // use alternate config if provided, else default one
...
if (! function_exists('anchor')) {
     ...
     * @param App|null            $altConfig  Alternate configuration to use
     */
    function anchor($uri = '', string $title = '', $attributes = '', $altConfig = null): string
    {
        // use alternate config if provided, else default one
        $config = $altConfig ?? config('App');
...
if (! function_exists('anchor_popup')) {
     ...
     * @param App|null                  $altConfig  Alternate configuration to use
     */
    function anchor_popup($uri = '', string $title = '', $attributes = false, $altConfig = null): string
    {
        // use alternate config if provided, else default one
        $config = $altConfig ?? config('App');
